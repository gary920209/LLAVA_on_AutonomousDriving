...
deepspeed llava/train/train_mem.py \
    --lora_enable True --lora_r 4 --lora_alpha 128 --use_dora False --mm_projector_lr 2e-5 --bb_encoder_lr 1e-4 \
    ...
    --bf16 True \
    --output_dir /mnt/HDD_1/walker/dlcv_checkpoints/llava-v1.5-7b-finetune-with-pretrain-lora-1223 \
    --num_train_epochs 1 \
